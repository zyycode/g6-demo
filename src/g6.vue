...
import { Graph, Arrow, TreeGraph } from '@antv/g6';
// import { treeData, data } from './const';
...
const width = containerRef.scrollWidth;
const height = containerRef.scrollHeight || 500;
